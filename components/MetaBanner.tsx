      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <a
            ...
            className="text-xl font-bold tracking-tight text-white transition hover:text-blue-200"
          >
            {meta.pr_title}
          </a>
          <p className="mt-2 text-sm text-slate-400">
            ...
            <span className="rounded-lg border border-white/10 bg-slate-950/60 px-2 py-1 font-mono text-xs text-slate-300">
              {meta.base_branch}
            </span>
